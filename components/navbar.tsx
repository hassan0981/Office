...
export function Navbar({ user }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-cream-300/60 bg-white/70 backdrop-blur-md">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          {user ? (
            <>
              ...
              {/* User badge */}
              <div className="hidden md:flex items-center gap-2 rounded-xl border border-cream-300 bg-cream-100/60 px-3 py-1.5 text-xs text-charcoal-700">
